...
# Set the label width W, length H
def fast_hist(a, b, n):
    # --------------------------------------------------------------------------------#
...
def F1(hist):
    ...
    recall = np.sum(np.diag(hist)) / np.maximum(np.sum(hist), 1)
...
def compute_mIoU(gt_dir, pred_dir, png_name_list, num_classes, name_classes=None):  
    ...
    f1 = F1(hist)
    #------------------------------------------------#
    # Output the mIoU values on a category-by-category basis.
    #------------------------------------------------#
    ...
    return IoUs, IoUs, PA_Recall, Precision
